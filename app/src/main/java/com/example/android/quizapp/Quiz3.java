...
public class Quiz3 extends AppCompatActivity {
    ...
    public static final int QUIZ3_CORRECT_ANSWER = 6;
    //global variables
    ...
    public void recieveIntent() {
        ...
        playerName = intent.getStringExtra(getString(R.string.player_name_intent_extra));//get playerName value from Quiz2
    ...
    protected boolean stringCompare() {
        ...
        if (getAnswer().getText().toString().equals(getString(R.string.empty_string))) {
            ...
            if (Integer.parseInt(getAnswer().getText().toString()) == QUIZ3_CORRECT_ANSWER) {
    ...
    public void done(View view) {
        if (stringCompare()) {
            ...
            getSolution().setText(getString(R.string.quiz3_solution) + QUIZ3_CORRECT_ANSWER + getString(R.string.period));
    ...
    /*
     * this toast will be shown if and only if user input a number
     */
    ...
    /*
     * this toast will be shown if and only if user input nothing
     */
